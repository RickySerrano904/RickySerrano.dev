  ...
  return (
    ...
    >
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-center lg:gap-8">
        ...
        <section className="github-calendar-card group w-full max-w-2xl rounded-3xl border border-white/10 bg-[#151922] p-4 shadow-[0_24px_60px_-40px_rgba(10,12,16,0.75)] transition-[transform,border-color,box-shadow] duration-300 hover:-translate-y-0.5 hover:border-[#ff9c6f] hover:shadow-[0_24px_70px_-38px_rgba(10,12,16,0.85),0_0_34px_-18px_#ff9c6f] md:col-span-2">
            <div className="mb-3 flex items-center justify-between gap-3">
              <h2 className="github-calendar-title text-sm font-semibold uppercase tracking-[0.2em] text-[#a6a7ab] transition-colors duration-300">
                GitHub Contributions
              </h2>
              <a
                href="https://github.com/RickyRicardo904"
                className="github-calendar-link inline-flex items-center gap-1.5 text-xs font-semibold text-[#f3f1e8] transition-colors duration-300 focus-visible:text-[#ff9c6f] focus-visible:outline-none"
              >
                View profile{" "}
