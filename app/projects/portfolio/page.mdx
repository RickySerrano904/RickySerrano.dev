...
<ProjectCaseStudyLayout
  ...
  summary={getProjectSummary("portfolio")}
  ...
  imageSrc="/projects/portfolio-project/portfolio screenshot.png"
  imageAlt="Ricky Serrano's portfolio homepage in dark mode with a profile photo and GitHub contribution graph"
>
